...
import (
	...
	"github.com/liooooo29/utls/internal/fips140tls"
	"github.com/liooooo29/utls/internal/hpke"
	"github.com/liooooo29/utls/internal/tls13"
)
...
func (c *UConn) echTranscriptMsg(outer *clientHelloMsg, echCtx *echClientContext) (err error) {
	...
	// See https://github.com/liooooo29/utls/blob/e430876b1d82fdf582efc57f3992d448e7ab3d8a/ech.go#L276-L283
